...
namespace Kopra.ViewModel
{
	class AddFilterViewModel : INotifyPropertyChanged
	{
		...
		private void InicjalizujIlośćInwestorów() => Investors = new List<Investor>
		{
	    ...
	    private void InicjalizujKwotęPożyczek() => LoanAmounts = new List<LoanAmount>
	    {
	    ...
	    private void InicjalizujOkresyPożyczek() => LoanPeriods = new List<LoanPeriod>
	    {
	    ...
	    private void InicjalizujOprocentowaniePożyczek() => LoanInterests = new List<Interest>
	    {
	    ...
	    private void InicjalizujRealizację() => Completions = new List<Completion>
	    {
	    ...
	    private void InicjalizujStatusyPożyczek() => StatusyPozyczek = new List<Status>
	    {
